...
{
    private final static Logger LOGGER = LoggerFactory.getLogger(RequireAuthenticationAspect.class);

    @Pointcut("@annotation(sem3.project.individual.configuration.security.auth.RequireAuthentication)")
    public void annotatedMethod(){
    }

    @Pointcut("@within(sem3.project.individual.configuration.security.auth.RequireAuthentication)")
